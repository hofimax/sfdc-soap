...
class Client extends AbstractHasDispatcher implements ClientInterface
{
     ...
     */
    public function __construct($soapClient, $username, $password, $token)
    {
    ...
    protected function call($method, array $params = array())
    {
        ...
        //echo var_dump($this->soapClient);

        try
        {
            //$t = microtime(1);
            //$result = $this->soapClient->$method($params);
            $result = $this->soapClient->__soapCall($method, array($params));
            //echo "METHOD: ".$method."\n";
        ...
        //file_put_contents(dirname(__FILE__)."/../../../../../../app/soap.txt", serialize($this->soapClient->_cookies));

        //apc_store('soapclient', $this->soapClient);
    ...
    protected function init()
    {
        ...
        //echo "init()\n"; print_r($this->getSessionHeader()); echo "headers end\n";

        if (!$this->getSessionHeader()) {
            
            //echo "login due to no session headers";
